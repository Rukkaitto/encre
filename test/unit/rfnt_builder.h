#pragma once
// Builds synthetic .rfnt v1 buffers in memory so Font::load can be exercised
// on inputs no real font file would contain (corrupt offsets, kern pairs,
...
//   blob             packed 1bpp rows, (bitmapW + 7) / 8 bytes per row
#include <cstdint>
#include <cstring>
#include <string>
#include <vector>
